...
ActiveRecord::Schema.define(version: 20180924111837) do
  ...
  create_table "talks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["bigcategory_id"], name: "index_talks_on_bigcategory_id"
    t.index ["smallcategory_id"], name: "index_talks_on_smallcategory_id"
